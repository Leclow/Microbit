...
def flappy():
    ...
    input.on_button_pressed(Button.A, onJ)
    
    
    def onb():
        zozio.change(LedSpriteProperty.Y, -1)
    input.on_button_pressed(Button.B, onb)
